...
class BettingServiceTest : IntegrationTestSupport {
    ...
    fun create1() {
        ...
        val goalEntity = createGoalEntity(userEntity, BILLING, PROCEEDING, LocalDateTime.now(), LocalDateTime.now().plusDays(7))
    ...
    fun loadUserAndGoal2() {
        ...
        val goalEntity = createGoalEntity(userEntity1, BILLING, PROCEEDING, LocalDateTime.now(), LocalDateTime.now().plusDays(7))
        goalRepository.save(goalEntity)
    ...
    fun findAllByGoalId1() {
        ...
        assertThat(foundBettingList).hasSize(2)
                ...
                .containsExactlyInAnyOrder(
                        tuple(bettingEntity1.userEntity.id, bettingEntity1.goalEntity.id, BettingPredictionType.FAIL, BettingResult.PROCEEDING),
                        tuple(bettingEntity2.userEntity.id, bettingEntity2.goalEntity.id, BettingPredictionType.SUCCESS, BettingResult.NO_GIFTICON),
                )
    }
    ...
    fun hardDeleteByUserId1() {
        ...
        // then
        assertThat(bettingRepository.findAllById(setOf(bettingEntity1.id, bettingEntity2.id, bettingEntity3.id, bettingEntity4.id)))
                .isEmpty()
    }
    ...
    private fun ObjectAssert<*>.extractingBettingProperties() = extracting("userId", "goalId", "bettingPredictionType", "bettingResult")

    private fun ListAssert<*>.extractingBettingProperties() = extracting("userId", "goalId", "bettingPredictionType", "bettingResult")
